...
#this method is made to send sms, by taking 2 inputs the method first intialize the connection with twillio the create sms using the inputs  
...
#Author: Omar A. Abdel-fatah
  ...
  def  test
    send_sms("+20126699638" #your client number
    ,"Hey, Welcome to Shipme Website ;)")
  end
  end
